...
/**
 * This will bootstrap RabbitMQ through Docker. See
 * {@link <a href="http://testcontainers.org">Testcontainers<a>}
 */
@Slf4j
@RunWith(SpringRunner.class)
@SpringBootTest(classes = { RabbitDemoApplication.class, RabbitSenderApplicationIntegrationTestConfiguration.class })
...
public class RabbitSenderApplicationDockerTest {
    ...
    public static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext configurableApplicationContext) {
            TestPropertyValues values = TestPropertyValues.of("spring.rabbitmq.host=" + rabbitmq.getContainerIpAddress(), "spring.rabbitmq.port=" + rabbitmq.getMappedPort(5672));
    ...
    public void shouldSendAtLeastASingleMessage() {
        ...
        Message msg = rabbitTemplate.receive("incoming-orders", 1500);
